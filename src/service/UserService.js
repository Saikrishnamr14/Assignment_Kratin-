...
class UserService {
  ...
  updateDietPlan(userId, dietPlanId, dietPlan) {
    return axios.put(
      `${BASE_API_URL}/${userId}/diet-plans/${dietPlanId}`,
      dietPlan
    );
  }
  ...
  getMedicinePlanById(userId, medicinePlanId) {
    return axios.get(
      `${BASE_API_URL}/${userId}/medicine-plans/${medicinePlanId}`
    );
  }
  ...
  updateHospital(userId, hospitalId, hospital) {
    return axios.put(
      `${BASE_API_URL}/${userId}/hospitals/${hospitalId}`,
      hospital
    );
  }
  ...
  getMedicalStoreById(userId, medicalStoreId) {
    return axios.get(
      `${BASE_API_URL}/${userId}/medical-stores/${medicalStoreId}`
    );
  }
  ...
  createEmergencyContact(userId, emergencyContact) {
    return axios.post(
      `${BASE_API_URL}/${userId}/emergency-contacts`,
      emergencyContact
    );
  }
  ...
  getEmergencyContactById(userId, emergencyContactId) {
    return axios.get(
      `${BASE_API_URL}/${userId}/emergency-contacts/${emergencyContactId}`
    );
  }
