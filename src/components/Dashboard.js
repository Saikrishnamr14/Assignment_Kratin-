    ...
    <>
      <div className="d-flex justify-content-center align-items-center vh-100 border">
        <div className="my-2">
          ...
          <button
            className={`btn btn-primary mb-2 mr-3 ${
              selectedTab === "medicine-plan" && "active"
            }`}
          ...
          <button
            className={`btn btn-primary mb-2 mr-3 ${
              selectedTab === "medical-store" && "active"
            }`}
          ...
          <button
            className={`btn btn-primary mb-2 mr-3 ${
              selectedTab === "emergency-contact" && "active"
            }`}
